...
async def ytdl(_, message):
    ...
    try:
        ...
        await message.reply_text("`Sorry Our Server Cannot Download That , If It Is Urgent Contact Customer Care And They Will Download For You`")
        return
    buttons = InlineKeyboardMarkup(list(create_buttons(formats)))
    sentm = await message.reply_text("Processing Your Link!! Share And Support Us")
    try:
